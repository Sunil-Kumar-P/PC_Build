...
<body>
    ...
    <div class="cbody">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td> <span>&#8377;</span><?php echo $row['Rprice']; ?>/-</td>
                            <td><?php echo $row['Description']; ?></td>
                            <td> <?php echo '<img class="d-block w-100" alt="..." src="data:image/png;base64,' . base64_encode($row['RAMimg']) . '">';  ?>
                            <td><?php echo $row['link']; ?></td>
                            <td>
                                <form action="deleteram.php" method="post">
                                    <input type="text" name="Rno" hidden="hidden" value="<?php echo $row['Rno']; ?>">
        ...
        <div class="container">
            <div class="p-3 m-3">
                <h3 class="alert text-primary rounded-pill" style="text-align:center">Insert a RAM</h3>
                <div class="col-lg-5 rounded mx-auto">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if (count($_FILES) > 0) {
                            if (!empty($_FILES["Image"]["name"])) {
                                ...
                                $sql = "INSERT INTO RAM  VALUES (null, '$Rname', '$imgcontent' ,'$Rprice', '$Description' , '$Link');";
                    ...
                    <form action="ram.php" method="POST" enctype="multipart/form-data" autocomplete="off">


                        <div class="form-group">
                            <label for="">Rname</label>
                            <input required type="text" name="Rname" id="" value="" class=" form-control-sm form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Rprice</label>
                            <input required type="text" name="Rprice" id="" class="form-control form-control-sm">
                        </div>
                        <div class="form-group">
