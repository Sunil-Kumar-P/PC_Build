...
<body>
    ...
    <div class="cbody">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td> <span>&#8377;</span><?php echo $row['Gprice']; ?>/-</td>
                            <td><?php echo $row['Description']; ?></td>
                            <td> <?php echo '<img class="d-block w-100" alt="..." src="data:image/png;base64,' . base64_encode($row['GPUimg']) . '">';  ?>
                            <td><?php echo $row['link']; ?></td>
                            <td>
                                <form action="deletegpu.php" method="post">
                                    <input type="text" name="gpuno" hidden="hidden" value="<?php echo $row['Gno']; ?>">
        ...
        <div class="container">
            <div class="p-3 m-3">
                <h3 class="alert text-primary rounded-pill" style="text-align:center">Insert a GPU</h3>
                <div class="col-lg-5 rounded mx-auto">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if (count($_FILES) > 0) {
                            if (!empty($_FILES["Image"]["name"])) {
                                ...
                                $sql = "INSERT INTO GPU  VALUES (null, '$Gname', '$imgcontent','$Gprice', '$Description' ,'$Link');";
                    ...
                    <form action="gpu.php" method="POST" enctype="multipart/form-data" autocomplete="off">


                        <div class="form-group">
                            <label for="">Gname</label>
                            <input required type="text" name="Gname" id="" value="" class=" form-control-sm form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Gprice</label>
                            <input required type="text" name="Gprice" id="" class="form-control form-control-sm">
                        </div>
                        <div class="form-group">
